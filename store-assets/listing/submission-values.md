# Chrome Web Store submission values — Asterfold 3.6.0
...
> Asterfold 3.6.0 does not request or require `activeTab`, `alarms`, or `contextMenus`. No active-tab URLs/titles are queried, and no background alarm loops run.
