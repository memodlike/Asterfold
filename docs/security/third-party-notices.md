...
Asterfold application code, product mark, wallpapers, themes, copy, and layout are original. The following direct packages are used under permissive licenses. Their full license texts remain available in each package distribution and upstream repository.
...
| `minisearch` | 7.2.0 | MIT | Local full-text search |
| `react`, `react-dom` | 19.2.0 | MIT | User interface runtime |
| `zod` | 4.1.10 | MIT | External-data and message validation |

## Build, test, and type dependencies

| Package group | Versions | License |
| --- | --- | --- |
| WXT / React module | `wxt` 0.20.27, `@wxt-dev/module-react` 1.1.3 | MIT |
| Vite / React plugin | `vite` 7.3.6, `@vitejs/plugin-react` 5.1.0 | MIT |
