...
Scope: Asterfold 2.2.3 default local-first MV3 release.
...
| Backup/import | Unknown fields, duplicates, orphan/deleted hierarchy, huge input | Strict bounded schemas, semantic preview, Worker parsing, cancellation and atomic commit | Dense allowed input still consumes bounded local resources |
