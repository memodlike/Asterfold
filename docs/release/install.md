...
5. Open a new tab and verify the version and Diagnostics. Schema migrations run transactionally; the current release upgrades schema 1 to schema 7 without clearing existing data.
