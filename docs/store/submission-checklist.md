# Chrome Web Store submission checklist — Asterfold 3.6.1
...
- [ ] Policy version is 3.6.1 and effective date is 26 September 2026.
...
- [ ] Uploaded ZIP has `manifest_version: 3` and version `3.6.1`.
