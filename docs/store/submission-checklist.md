# Chrome Web Store submission checklist — Asterfold 3.3.0
...
- [ ] Policy version is 3.3.0 and effective date is 7 August 2026.
...
- [ ] Uploaded ZIP has `manifest_version: 3` and version `3.3.0`.
