# Chrome Web Store submission checklist — Asterfold 3.0.1
...
- [ ] Policy version is 3.0.1 and effective date is 28 July 2026.
...
- [ ] Uploaded ZIP has `manifest_version: 3` and version `3.0.1`.
