# Chrome Web Store submission checklist — Asterfold 3.6.0
...
- [ ] Policy version is 3.6.0 and effective date is 24 September 2026.
...
- [ ] Uploaded ZIP has `manifest_version: 3` and version `3.6.0`.
