# Chrome Web Store submission checklist — Asterfold 3.5.1
...
- [ ] Policy version is 3.5.1 and effective date is 16 September 2026.
...
- [ ] Uploaded ZIP has `manifest_version: 3` and version `3.5.1`.
