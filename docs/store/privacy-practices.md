# Chrome Web Store Privacy Practices — Asterfold 3.5.2

Prepared for the Asterfold 3.5.2 release. These are recommended dashboard answers for the reviewed default release. Recheck every answer against the final uploaded ZIP before submission.
...
The owner can certify the following for the reviewed 3.5.2 default build:
