...
export const BUILTIN_WALLPAPERS = [
  { id: "builtin-aurora", labelKey: "settings.wallpaperAurora", value: 'url("/wallpapers/quiet-aurora.webp")', compatibilityValue: 'url("/wallpapers/quiet-aurora-compat.svg")' },
  { id: "builtin-mesh", labelKey: "settings.wallpaperMesh", value: 'url("/wallpapers/blue-mesh.webp")', compatibilityValue: 'url("/wallpapers/blue-mesh-compat.svg")' },
  { id: "builtin-dusk", labelKey: "settings.wallpaperDusk", value: 'url("/wallpapers/dusk.webp")', compatibilityValue: 'url("/wallpapers/dusk-compat.svg")' },
] as const;
