...
const en: Record<MessageKey, string> = {
  ...
  "trash.title": "Trash", "trash.description": "Deleted items can be restored before automatic cleanup.", "trash.empty": "Trash is empty", "trash.emptyBody": "Deleted pages, boards and bookmarks will appear here.", "trash.restore": "Restore", "trash.emptyAction": "Empty trash", "trash.all": "All", "trash.pages": "Pages", "trash.boards": "Boards", "trash.bookmarks": "Bookmarks", "trash.items": "Items: {count}", "trash.restored": "Restored from trash", "trash.permanent": "Delete permanently", "trash.confirmItem": "Delete this item permanently? It cannot be restored from Trash.", "trash.deleted": "Permanently deleted",
