...
Asterfold 2.0.1 — рабочее local-first расширение после полного редизайна. Оно не требует аккаунта и готово к локальной установке через `release/chrome-unpacked`.
