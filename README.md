...
Asterfold 2.0.0 — рабочее local-first расширение после полного редизайна. Оно не требует аккаунта и готово к локальной установке через `release/chrome-unpacked`.
