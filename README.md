...
Asterfold 2.0.2 — рабочее local-first расширение после полного редизайна. Оно не требует аккаунта, автоматически упрощает визуальные эффекты на слабых компьютерах и готово к локальной установке через `release/chrome-unpacked`.
