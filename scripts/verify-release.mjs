...
if (first.some((value, index) => value !== second[index])) throw new Error("Release artifacts, SBOM, provenance, or checksums are not reproducible");
